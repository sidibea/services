...
<script type="text/javascript">
	...
	var CASE27_Explore_Listings__Listing_Wrap = <?php echo json_encode($data['listing-wrap']) ?>;
	var CASE27_Explore_Listings__Active_Category = <?php echo json_encode( $explore->active_category ? $explore->active_category->get_id() : false ) ?>;
	var CASE27_Explore_Listings__Active_Region = <?php echo json_encode( $explore->active_region ? $explore->active_region->get_id() : false ) ?>;
	var CASE27_Explore_Listings__Active_Tag = <?php echo json_encode( $explore->active_tag ? $explore->active_tag->get_id() : false ) ?>;
	var CASE27_Explore_Listings__Active_Tab = <?php echo json_encode( $explore->get_active_tab() ) ?>;

	<?php if ( $explore->get_active_listing_type() ): ?>
		var CASE27_Explore_Listings__Active_Listing_Type = <?php echo json_encode([
